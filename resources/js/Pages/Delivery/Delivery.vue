        ...
        <Card>
            <template #title>
                <div class="flex justify-between">
                    ...
                    <div class="text-lg">
                        <Dropdown v-model="filter" :options="filterOptions" showClear optionLabel="name" placeholder="Filter by Date" class="md:w-14rem" />
                    </div>
                </div>
            </template>
            <template #content>
...
const filterOptions = [
    ...
    { name: 'Day after tomorrow', code: 'day_after_tomorrow' },
